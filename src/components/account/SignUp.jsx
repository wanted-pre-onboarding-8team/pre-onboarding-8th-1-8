...
const SignUp = () => {
  ...
  const form = {
    email: useInput({
      initialValue: '', type: 'email', errorMessage: MESSAGE.EMAIL_ERROR, required: true
    }), password: useInput({
      initialValue: '', type: 'password', errorMessage: MESSAGE.PASSWORD_ERROR, required: true
    }), pwdCheck: useInput({
      initialValue: '', errorMessage: MESSAGE.PASSWORD_CHECK_ERROR, required: true
    })
  };
  ...
  const handleOnSubmit = event => {
    ...
    handleRequest({
      submitFunction: signUp, formData: { email: form.email.value, password: form.password.value }, action: 'SIGN_UP'
    });
  };
